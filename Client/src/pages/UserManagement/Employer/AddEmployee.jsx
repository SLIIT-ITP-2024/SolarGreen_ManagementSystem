...
function AddEmployee () {
  ...
  const Submit =(e) => {
    e.preventDefault();
    axios.post("http://localhost:3001/addEmployee", {employeeName, employeeId, phoneNumber, email, role, startingDate, endingDate, personalDetails})
    .then(result => {
      console.log(result)
      navigate('/')
    })
  ...
  return(
    <div className="d-flex vh-100 bg-primary justify-content-center align-item-center">
      <div className="w-50 bg-white rounded p-3">
        <from onSubmit={Submit} onClick={Cancel}>
          <h2>Add Employee</h2>
          <div className="mb-2">
          ...
          <div className="mb-2">
            ...
            <input type="date" placeholder="Enter Starting Date" className="form-control"
            onChange={(e) => setStartingDate(e.target.value)}/>
          </div>
          <div className="mb-2">
            <label htmlFor="">Ending Date</label>
            <input type="date" placeholder="Enter Ending Date" className="form-control"
